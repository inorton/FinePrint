...
{
    public class FacilityContract : ContractBase
    {
        ...
        {
            return base.HasRequiredTech() && TechTree.AreFacilitiesUnlocked();
        }
        ...
        public override bool GenerateContract()
        {
            ...
            else if (this.prestige == Contract.ContractPrestige.Significant)
            {
                ...
                if (TechTree.AreWheelsUnlocked() && onLand)
                {
                    if (generator.Next(0, 100) > 90)
                    {
        ...
        protected override void OnLoad(ConfigNode node)
        {
            ...
            Util.LoadNode(node, ClassName, "onLand", ref onLand, false);
            Util.LoadNode(node, ClassName, "typeString", ref typeString, "potato");
            Util.LoadNode(node, ClassName, "capacity", ref capacity, 8);
        }

...
{
    public class ARMContract : ContractBase
    {
        ...
        {
            return base.HasRequiredTech() && Util.haveTechnology("GrapplingDevice");
        }
        ...
        protected override void OnLoad(ConfigNode node)
        {
            ...
            Util.LoadNode(node, ClassName, "asteroidClass", ref asteroidClass, "A");
            Util.LoadNode(node, ClassName, "isLanding", ref isLanding, false);
        }
